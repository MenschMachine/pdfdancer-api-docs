...
function renderIndex(language, manifest, symbols) {
  ...
  const lines = [
    ...
    `description: Public ${config.label} types and members in PDFDancer SDK 3.0.0.`,
    '---',
    '',
    '<!-- Generated by scripts/generate-v3-reference.js. Do not edit manually. -->',
    '',
    ...
    '',
    `This reference covers the supported public surface of \`${config.packageName} 3.0.0\`, extracted from commit [\`${manifest.candidateCommit.slice(0, 12)}\`](https://github.com/MenschMachine/${manifest.repository}/tree/${manifest.candidateCommit}).`,
    '',
  ];
