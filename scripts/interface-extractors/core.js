...
function renderDiffMarkdown(diff) {
  const lines = [
    '# v3 public interface diff',
    '',
    '> Generated by `npm run extract:v3-interfaces`. Do not edit this file manually.',
    '',
    'This report compares the configured committed base and candidate refs. It does not inspect uncommitted SDK changes. Start with [the review summary](./v3-interface-summary.md), then use this file for exact changes to retained symbols.',
    '',
  ];
