...
The reference pages list the supported public types and members for the documented SDK releases: Python `3.0.2`, TypeScript `3.0.1`, and Java `3.0.1`. Use the task guides to learn a workflow and the reference to confirm exact names, signatures, return types, and exceptions.
