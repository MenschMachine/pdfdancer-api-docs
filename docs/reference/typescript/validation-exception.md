...
description: "TypeScript API reference for ValidationException. Exception raised for input validation errors. This public class belongs to the exceptions package and documents API behavior used for PDF document editing and inspection in PDFDancer SDK 3.0.1."
