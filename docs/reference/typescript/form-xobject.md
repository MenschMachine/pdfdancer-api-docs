...
id: form-xobject
title: "FormXObject"
description: "TypeScript API reference for FormXObject This public class belongs to the types package and documents API behavior used for PDF document editing and inspection in PDFDancer SDK 3.0.0."
