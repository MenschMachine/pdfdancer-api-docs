...
id: bounding-rect
title: "BoundingRect"
description: "TypeScript API reference for BoundingRect. Represents a bounding rectangle with position and dimensions. This public class belongs to the models package and documents API behavior used for PDF document editing and inspection in PDFDancer SDK 3.0.0."
