...
description: "TypeScript API reference for FormFieldObject. A selected interactive AcroForm field and its stored value. This public class belongs to the types package and documents API behavior used for PDF document editing and inspection in PDFDancer SDK 3.0.1."
