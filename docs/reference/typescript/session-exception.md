...
description: "TypeScript API reference for SessionException. Exception raised for session-related errors. Occurs when session creation fails or session is invalid."
...
```typescript
constructor(message: string, cause?: Error): SessionException
```
