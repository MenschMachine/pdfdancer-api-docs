...
id: font-type
title: "FontType"
description: "Python API reference for FontType. Font type classification from the PDF. This public enum belongs to the models package and documents API behavior used for PDF document editing and inspection in PDFDancer SDK 3.0.1."
