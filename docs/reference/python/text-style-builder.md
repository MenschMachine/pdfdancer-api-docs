...
description: "Python API reference for TextStyleBuilder. Build a validated request that changes existing text appearance. This public class belongs to the text_editing package and documents API behavior used for PDF document editing and inspection in PDFDancer SDK 3.0.2."
