...
- Added new "Clipping" section to `docs/working-with-vector-graphics.md` with code examples for all three SDKs (Python, TypeScript, Java)
- Added "Clipping" term definition to `docs/glossary.md` explaining clipping paths and the `clear_clipping()` method
- Updated `docs/roadmap.md` to add "Clear Clipping" to the "Recently Shipped" section
- Updated `docs/sdk-versions.md` with:
  - Documentation version bump to 8.7 (March 10, 2026)
  - Python SDK updated to 0.3.12
  - TypeScript SDK updated to 2.0.15
  - Java SDK updated to 0.2.14
  - Added "Clear Clipping API" feature checklist items for all SDKs
  - Added changelog entry for Version 8.7 documenting the clear clipping feature