...
See [Authentication](./authentication.md) for the supported credential sources.
...
See [When visible text does not match](./working-with-text.md#when-visible-text-does-not-match).
...
See [Read the response](./working-with-text.md#read-the-response) and [Text Layout and Reflow](./text-layout.md).
...
See [Finding Existing Objects](./finding-content.md) and [Positioning and Coordinates](./positioning.md).
...
See [Troubleshooting misplaced content](./positioning.md#troubleshooting-misplaced-content).
...
See [Working with Fonts](./working-with-fonts.md).
...
See [Error Handling](./error-handling.md) and [Advanced Usage](./advanced.md).
...
See [Preservation and PDF/A](./preservation-and-pdfa.md).
